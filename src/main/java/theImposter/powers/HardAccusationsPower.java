...
//import theImposter.actions.HardAccusationsEnemyAction;
//import theImposter.actions.HardAccusationsSelfAction;
//import theImposter.cards.EasyModalChoiceCard;
...
//            easyCardList.add(new EasyModalChoiceCard("", "Gain 2 Votes.", () -> atb(new HardAccusationsSelfAction())));
//            easyCardList.add(new EasyModalChoiceCard("", "Apply 2 Votes to ALL enemies.", () -> atb(new HardAccusationsEnemyAction())));
